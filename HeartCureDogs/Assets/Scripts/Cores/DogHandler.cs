...
{
    public static class DogHandler
    {
        ...
        /// <returns></returns>
        public static async Task<SendData> GenerateDogResponse(List<SendData> chatHistory, float temperature = 0.6f, List<DogTools> toolList = null)
        {
        GenerateResponse:
            // 将请求转化为JSON
        ...
        /// </summary>
        /// <returns></returns>
        public static DogFunctionsTools GetDummyFunctionTool()
        {
            DogFunctionsTools tool = new DogFunctionsTools("get_flight_number", "根据始发地、目的地和日期，查询对应日期的航班号");
